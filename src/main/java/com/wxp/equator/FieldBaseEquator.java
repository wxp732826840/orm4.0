    ...
    public List<FieldInfo> getDiffFields(Object first, Object second) {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                // 封装字段信息
                FieldNameInfo fieldNameInfo = field.getAnnotation(FieldNameInfo.class);
                FieldInfo fieldInfo = null;
                if (fieldNameInfo != null) {
                    fieldInfo = new FieldInfo(fieldName, field.getType(), firstVal, secondVal, fieldNameInfo.value());
                } else {
                    fieldInfo = new FieldInfo(fieldName, field.getType(), firstVal, secondVal);
                }
